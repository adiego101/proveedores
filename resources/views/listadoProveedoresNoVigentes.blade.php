...
@push('head')
    <title>Proveedores no vigentes</title>
...
@section('content2')
<h2 class="h2 text-center font-weight-bold ">Proveedores no vigentes</h2>

<hr>


<div class="table container-fluid overflow-auto" id="tabla">
    <table id="tabla_no_vigentes" style="width:100%" class="table table-hover yajra-no-vigentes">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.yajra-no-vigentes').DataTable({
    language: {
        "decimal": "",
