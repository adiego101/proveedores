                    ...
                    <div class="col-sm">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <input type="text" onkeypress="return valideKey(event);" class="form-control" placeholder="Ej: 02966" aria-describedby="basic-addon1" id="modal_telefono_sucursal_cod" maxlength="10">
                            </div>
                            <div class="col-sm">
