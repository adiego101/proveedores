<div class="modal fade" id="show_disposicion" role="dialog" aria-labelledby="showDisposicionModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="showDisposicionModalLabel">ver disposición</h5>
