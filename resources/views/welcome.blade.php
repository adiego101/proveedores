    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-primary text-white overflow-hidden shadow sm:rounded-lg">
                    <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                        <img width="100%" src="JEFATURA.png" alt="Santa Cruz">
                    </div>
                ...
                <footer class="main-footer justify-content-center ">
                    <div class="container-fluid text-center">
                        <strong>Secretaría de Estado de Modernización e Innovación Tecnológica, Jefatura de Gabinete,
                            Provincia de Santa Cruz</strong>
                    </div>
                </footer>
            </div>
        </div>
