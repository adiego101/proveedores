<div class="ui-widget">
    ...
    <input type="text" class="form-control dni" placeholder="Ingrese el dni del representante legal" @if ( $mode == "show") readonly @endif
    ...
    <small class="small" id="small-dni-{{$tipo_persona}}"></small>
</div>
<br>
...
<small class="small" id="small-apellido-{{$tipo_persona}}"></small><br>
...
<small class="small" id="small-nombre-{{$tipo_persona}}"></small><br>
<div id="div_cargo_{{$tipo_persona}}_{{$mode}}" @if($tipo_persona!='direccion_firma')style="display:none;"@endif>
    ...
    <small class="small" id="small-cargo-{{$tipo_persona}}"></small><br>
</div>