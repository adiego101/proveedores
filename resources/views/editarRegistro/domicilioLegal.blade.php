    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <input type="text" class="form-control" placeholder="Ingrese la calle" aria-describedby="basic-addon1" id="calle_legal" name="calle_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->calle) ? $proveedor_domicilio_legal->calle : '' }}"><br>

                <label for="dpto_legal">Departamento:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese el departamento" aria-describedby="basic-addon1" id="dpto_legal" name="dpto_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->dpto) ? $proveedor_domicilio_legal->dpto : '' }}"><br>

                <label for="lote_legal">Lote:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de lote" aria-describedby="basic-addon1" id="lote_legal" name="lote_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->lote) ? $proveedor_domicilio_legal->lote : '' }}"><br>

                <label for="entreCalles_legal">Entre Calles:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese las calles correspondientes" aria-describedby="basic-addon1" id="entreCalles_legal" name="entreCalles_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->entre_calles) ? $proveedor_domicilio_legal->entre_calles : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese el monoblock" aria-describedby="basic-addon1" id="monoblock_legal" name="monoblock_legal" @if ( $mode == "show") readonly @endif
                ...
                <input type="email" class="form-control" placeholder="ejemplo@dominio.com"
                    ...
                    <div class="field_email_legal">
                        ...
                        @forelse($proveedor_email_legal as $email_legal)
                            ...
                            <label for="email_legal">Correo electrónico:</label><br>
                            <input type="email"  onkeypress="return valideKey(event);" class="form-control" placeholder="ejemplo@dominio.com" aria-describedby="basic-addon1" id="email_legal" name="email_legal[]" @if ( $mode == "show") readonly @endif
value="{{$email_legal->email}}"> <br>
                        @empty
                ...
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de teléfono"
                    ...
                    <div class="field_telefono_legal">
                        ...
                        @forelse($proveedor_telefono_legal as $telefono_legal)
                            ...
                            <label for="telefono_legal">Teléfono:</label><br>
                            <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de teléfono" aria-describedby="basic-addon1" id="telefono_legal" name="telefono_legal[]" @if ( $mode == "show") readonly @endif
value="{{$telefono_legal->nro_tel}}"> <br>
                        @empty
            ...
            <div class="col-sm">
                ...
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de la calle" aria-describedby="basic-addon1" id="numero_legal" name="numero_legal"  @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->numero) ? $proveedor_domicilio_legal->numero : '' }}"><br>

                <label for="puerta_legal">Puerta:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de puerta" aria-describedby="basic-addon1" id="puerta_legal" name="puerta_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->puerta) ? $proveedor_domicilio_legal->puerta : '' }}"><br>

                <label for="manzana_legal">Manzana:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de manzana" aria-describedby="basic-addon1" id="manzana_legal" name="manzana_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->manzana) ? $proveedor_domicilio_legal->manzana : '' }}"><br>

                <label for="oficina_legal">Oficina:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese la oficina" aria-describedby="basic-addon1" id="oficina_legal" name="oficina_legal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_legal->oficina) ? $proveedor_domicilio_legal->oficina : '' }}"><br>

                <label for="barrio_legal">Barrio:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese el barrio" aria-describedby="basic-addon1" id="barrio_legal" name="barrio_legal" @if ( $mode == "show") readonly @endif
...
value="{{ isset($proveedor_domicilio_legal->codigo_postal) ? $proveedor_domicilio_legal->codigo_postal : '' }}"><br>

@if ( $mode != "show")

                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="javascript:void(0);" class="add_email_legal" title="Agregue un nuevo correo"><input type="button" @if ( $mode == "show") readonly @endif
value="Agregar Correo" class="btn btn-success"></a>
                ...
                <br>
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="javascript:void(0);" class="add_telefono_legal" title="Agregue un nuevo teléfono"><input type="button" @if ( $mode == "show") readonly @endif
    ...
    $(document).ready(function() {
        ...
        var fieldHTML_telefono_legal = '<div>'+
                                 '<br>'+
                                    ...
                                    '<a href="javascript:void(0);" class="remove_telefono_legal" title="Elimine el teléfono"><input type="button" @if ( $mode == "show") readonly @endif
value="Eliminar" class="btn btn-danger btn-xs"></a>'+
        ...
        var fieldHTML_email_legal = '<div>'+
                                    ...
                                    '<a href="javascript:void(0);" class="remove_email_legal" title="Elimine el correo"><input type="button" @if ( $mode == "show") readonly @endif
value="Eliminar" class="btn btn-danger btn-xs"></a>'+
                                    '<br>'+
                                    '<br>'+
                                '</div>';
...
<script type="text/javascript">
    ...
    function recargarListaLegal2(){
        $.ajax({
            type:"GET",
            url:"{{url('localidadSelect/'.$proveedor_domicilio_legal->id_localidad)}}",
            success:function(r){
                $('#localidad_legal').html(r);
            }
        });
