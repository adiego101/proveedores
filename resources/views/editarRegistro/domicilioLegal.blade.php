                ...
                <div class="field_telefono_legal">
                    ...
                    <div class="row">
                        ...
                        @forelse($proveedor_telefono_legal as $telefono_legal)
                            ...
                            <input type="text" onkeypress="return valideKey(event);" class="form-control" placeholder="Ej: 02966" aria-describedby="basic-addon1" id="telefono_legal_cod" name="telefono_legal_cod[]" @if ( $mode == "show") readonly @endif value="{{$telefono_legal->cod_area_tel}}" maxlength="4"> <br>
                        @empty
                            <label for="telefono_legal_cod">Código de área:</label><br>
                            <input type="text" onkeypress="return valideKey(event);" class="form-control" placeholder="Ej: 02966" aria-describedby="basic-addon1" id="telefono_legal_cod" name="telefono_legal_cod[]" maxlength="4"> <br>
                            @endforelse
                        </div>
        ...
        $(addTelefono_legal).click(function() {
            ...
            var fieldHTML_telefono_legal = '<div>'+'<div class="row">'+
                                 ...
                                 '<label for="telefono_legal_cod' + x +'">Código de área:</label><br>'+
                                    '<input type="text" onkeypress="return valideKey(event);" class="form-control" placeholder="Ej: 02966" aria-describedby="basic-addon1" id="telefono_legal_cod' + x +'" name="telefono_legal_cod[]" maxlength="4">'+
                                    '</div>'+
                                    '<div class="col-sm">'+
                                    '<br>'+
