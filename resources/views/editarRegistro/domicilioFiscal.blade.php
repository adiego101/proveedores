    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <option value="{{$proveedor_localidades_fiscal->nombre_localidad}}">{{$proveedor_localidades_fiscal->nombre_localidad}}</option>
                </select>
                <br>
            ...
            <div class="col-sm">
                ...
                <option value="{{$proveedor_provincias_fiscal->nombre_provincia}}">{{$proveedor_provincias_fiscal->nombre_provincia}}</option>
