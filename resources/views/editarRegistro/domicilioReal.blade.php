    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <input type="text" class="form-control" placeholder="Ingrese la calle" aria-describedby="basic-addon1" id="calle_real" name="calle_real" @if ( $mode == "show") readonly @endif maxlength="50"
...
value="{{ isset($proveedor_domicilio_real->dpto) ? $proveedor_domicilio_real->dpto : '' }}"><br>
                ...
                <input type="text" onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de lote" aria-describedby="basic-addon1" id="lote_real" name="lote_real" @if ( $mode == "show") readonly @endif maxlength="4"
value="{{ isset($proveedor_domicilio_real->lote) ? $proveedor_domicilio_real->lote : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese las calles correspondientes" aria-describedby="basic-addon1" id="entreCalles_real" name="entreCalles_real" @if ( $mode == "show") readonly @endif maxlength="70"
...
value="{{ isset($proveedor_domicilio_real->puerta) ? $proveedor_domicilio_real->puerta : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese el número de manzana" aria-describedby="basic-addon1" id="manzana_real" name="manzana_real" @if ( $mode == "show") readonly @endif
...
value="{{ isset($proveedor_domicilio_real->oficina) ? $proveedor_domicilio_real->oficina : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese el barrio" aria-describedby="basic-addon1" id="barrio_real" name="barrio_real" @if ( $mode == "show") readonly @endif maxlength="50"
