    ...
    <div class="container">
        <div class="row">
            <div class="col-sm">
                ...
                <input type="text" class="form-control" placeholder="Ingrese la calle" aria-describedby="basic-addon1" id="calle_real" name="calle_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->calle) ? $proveedor_domicilio_real->calle : '' }}"><br>

                <label for="dpto_real">Departamento:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese el departamento" aria-describedby="basic-addon1" id="dpto_real" name="dpto_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->dpto) ? $proveedor_domicilio_real->dpto : '' }}"><br>

                <label for="lote_real">Lote:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de lote" aria-describedby="basic-addon1" id="lote_real" name="lote_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->lote) ? $proveedor_domicilio_real->lote : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese las calles correspondientes" aria-describedby="basic-addon1" id="entreCalles_real" name="entreCalles_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->entre_calles) ? $proveedor_domicilio_real->entre_calles : '' }}"><br>
                ...
                <input type="text" class="form-control" placeholder="Ingrese el monoblock" aria-describedby="basic-addon1" id="monoblock_real" name="monoblock_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->monoblock) ? $proveedor_domicilio_real->monoblock : '' }}"><br>
                ...
                <select class="form-control" @if ( $mode == "show") disabled @endif aria-describedby="basic-addon1" id="pais_real" name="pais_real">
                    @forelse($paises as $pais)
                        <option selected
value="{{$pais->nombre_pais}}">{{$pais->nombre_pais}}</option>
                    @empty
                        <option
value=" "></option>
                    @endforelse
                ...
                <input type="text" class="form-control" placeholder="Ingrese la página web"
                    aria-describedby="basic-addon1" id="pagina_web" name="pagina_web" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor->pagina_web) ? $proveedor->pagina_web : '' }}"><br>
                ...
                <div class="field_email_real">
                    ...
                    @forelse($proveedor_email_real as $email_real)
                        ...
                        <label for="email_real">Correo electrónico:</label><br>
                        <input type="email"  onkeypress="return valideKey(event);" class="form-control" placeholder="ejemplo@dominio.com" aria-describedby="basic-addon1" id="email_real" name="email_real[]" @if ( $mode == "show") readonly @endif
value="{{$email_real->email}}"> <br>
                    @empty
                ...
                <div class="field_telefono_real">
                    ...
                    @forelse($proveedor_telefono_real as $telefono_real)
                        ...
                        <label for="telefono_real">Teléfono:</label><br>
                        <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de teléfono" aria-describedby="basic-addon1" id="telefono_real" name="telefono_real[]" @if ( $mode == "show") readonly @endif
value="{{$telefono_real->nro_tel}}"> <br>
                    @empty
            ...
            <div class="col-sm">
                ...
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de la calle" aria-describedby="basic-addon1" id="numero_real" name="numero_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->numero) ? $proveedor_domicilio_real->numero : '' }}"><br>

                <label for="puerta_real">Puerta:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de puerta" aria-describedby="basic-addon1" id="puerta_real" name="puerta_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->puerta) ? $proveedor_domicilio_real->puerta : '' }}"><br>

                <label for="manzana_real">Manzana:</label><br>
                <input type="number"  onkeypress="return valideKey(event);" class="form-control" placeholder="Ingrese el número de manzana" aria-describedby="basic-addon1" id="manzana_real" name="manzana_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->manzana) ? $proveedor_domicilio_real->manzana : '' }}"><br>

                <label for="oficina_real">Oficina:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese la oficina" aria-describedby="basic-addon1" id="oficina_real" name="oficina_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->oficina) ? $proveedor_domicilio_real->oficina : '' }}"><br>

                <label for="barrio_real">Barrio:</label><br>
                <input type="text" class="form-control" placeholder="Ingrese el barrio" aria-describedby="basic-addon1" id="barrio_real" name="barrio_real" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->barrio) ? $proveedor_domicilio_real->barrio : '' }}"><br>
                ...
                <input type="text" class="form-control" aria-describedby="basic-addon1" id="cp_real" name="cp_real" placeholder="Ingrese el código postal" @if ( $mode == "show") readonly @endif
value="{{ isset($proveedor_domicilio_real->codigo_postal) ? $proveedor_domicilio_real->codigo_postal : '' }}"><br>
...
@if ( $mode != "show")
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="javascript:void(0);" class="add_email_real" title="Agregue un nuevo correo"><input type="button" @if ( $mode == "show") readonly @endif
value="Agregar Correo" class="btn btn-success"></a>
                ...
                <br>
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="javascript:void(0);" class="add_telefono_real" title="Agregue un nuevo teléfono"><input type="button" @if ( $mode == "show") readonly @endif
    ...
    $(document).ready(function() {
        ...
        var fieldHTML_telefono_real = '<div>'+
                                 '<br>'+
                                    ...
                                    '<a href="javascript:void(0);" class="remove_telefono_real" title="Elimine el teléfono"><input type="button" @if ( $mode == "show") readonly @endif
value="Eliminar" class="btn btn-danger btn-xs"></a>'+
        ...
        var fieldHTML_email_real = '<div>'+
                                    ...
                                    '<a href="javascript:void(0);" class="remove_email_real" title="Elimine el correo"><input type="button" @if ( $mode == "show") readonly @endif
value="Eliminar" class="btn btn-danger btn-xs"></a>'+
                                    '<br>'+
                                    '<br>'+
                                '</div>';
