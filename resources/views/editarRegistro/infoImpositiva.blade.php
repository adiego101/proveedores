...
<fieldset>
  ...
  <input type="text" class="form-control" aria-describedby="basic-addon1" placeholder="Ingrese el código de la actividad" id="excento-actividad" name="excento-actividad" ><br>
  ...
  <div>
    <input type="radio" id="corresponde" name="retencion" value="1" checked>
    <label for="corresponde">SI</label>

    <input type="radio" id="no-corresponde" name="retencion" value="0">
...
<fieldset>
  ...
  <input type="number" class="form-control" placeholder="ingrese el número de ingresos brutos" aria-describedby="basic-addon1" id="ingresos-brutos" name="ingresos-brutos" ><br>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm">
        ...
        <input type="number" class="form-control" placeholder="ingrese el número de habilitación municipal" aria-describedby="basic-addon1" id="habilitacion-municipal" name="habilitacion-municipal" ><br>
      </div>
      <div class="col-sm">
        <label for="localidad">Localidad:</label><br>
        <input type="text" class="form-control" placeholder="ingrese la localidad correspondiente" aria-describedby="basic-addon1" id="localidad" name="localidad" ><br>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm">
        ...
        <input type="number" class="form-control" placeholder="ingrese el número de inscripción de personas jurídicas" aria-describedby="basic-addon1" id="inscripcion-juridicas" name="inscripcion-juridicas" ><br>
      </div>
      <div class="col-sm">
        <label for="provincia-juridicas">Provincia:</label><br>
        <input type="text" class="form-control" placeholder="ingrese la provincia correspondiente" aria-describedby="basic-addon1" id="provincia-juridicas" name="provincia-juridicas" ><br>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm">
        ...
        <input type="text" class="form-control" placeholder="ingrese el registro público de comercio" aria-describedby="basic-addon1" id="registro-comercio" name="registro-comercio" ><br>
      </div>
      <div class="col-sm">
        <label for="provincia-comercio">Provincia:</label><br>
        <input type="text" class="form-control" placeholder="ingrese la provincia correspondiente" aria-describedby="basic-addon1" id="provincia-comercio" name="provincia-comercio" ><br>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm">
        ...
        <input type="text" class="form-control" placeholder="ingrese la inspección general de justicia" aria-describedby="basic-addon1" id="inspeccion-justicia" name="inspeccion-justicia" ><br>
      </div>
      <div class="col-sm">
        <label for="provincia-justicia">Provincia:</label><br>
        <input type="text" class="form-control" placeholder="ingrese la provincia correspondiente" aria-describedby="basic-addon1" id="provincia-justicia" name="provincia-justicia" ><br>
      </div>
    </div>
  </div>
